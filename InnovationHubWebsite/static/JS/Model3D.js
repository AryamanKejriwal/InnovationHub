...
const MATERIAL = [new THREE.MeshPhongMaterial({color: 0x1a3c40, shininess: 50, specular: 0x1a3c40}), new THREE.MeshStandardMaterial({color: 0x1a3c40, roughness: 0.4, metalness: 0.3})];
